...
try_flip_window_position (MetaWindow                  *window,
                          ...
                          MetaPlacementConstrainAction constrain_action,
                          MetaRectangle               *rect,
                          MetaRectangle               *intersection)
{
  ...
  switch (constrain_action)
    {
    case META_PLACEMENT_CONSTRAIN_ACTION_FLIP_X:
      placement_rule_flip_horizontally (&flipped_rule);
      break;
    case META_PLACEMENT_CONSTRAIN_ACTION_FLIP_Y:
  ...
  if ((constrain_action == META_PLACEMENT_CONSTRAIN_ACTION_FLIP_X &&
       flipped_intersection.width == flipped_rect.width) ||
      (constrain_action == META_PLACEMENT_CONSTRAIN_ACTION_FLIP_Y &&
                       ...
                       gboolean            check_only)
{
  ...
  x_constrain_actions = (META_PLACEMENT_CONSTRAIN_ACTION_SLIDE_X |
                         META_PLACEMENT_CONSTRAIN_ACTION_FLIP_X);
  y_constrain_actions = (META_PLACEMENT_CONSTRAIN_ACTION_SLIDE_Y |
                         META_PLACEMENT_CONSTRAIN_ACTION_FLIP_Y);
  if ((placement_rule->constrain_action & x_constrain_actions &&
       info->current.width != intersection.width) ||
      (placement_rule->constrain_action & y_constrain_actions &&
  ...
  if (info->current.width != intersection.width &&
      current_rule.constrain_action & META_PLACEMENT_CONSTRAIN_ACTION_FLIP_X)
    {
  ...
  if (info->current.height != intersection.height &&
      current_rule.constrain_action & META_PLACEMENT_CONSTRAIN_ACTION_FLIP_Y)
    {
      try_flip_window_position (window, info, &current_rule,
                                META_PLACEMENT_CONSTRAIN_ACTION_FLIP_Y,
                                &info->current, &intersection);
  ...
  if (current_rule.constrain_action & META_PLACEMENT_CONSTRAIN_ACTION_SLIDE_X)
    {
  ...
  if (current_rule.constrain_action & META_PLACEMENT_CONSTRAIN_ACTION_SLIDE_Y)
    {
