...
meta_settings_register_proxy (MetaSettings      *settings,
                              MetaSettingsProxy *proxy)
{
  g_hash_table_add (settings->proxies, proxy);
}

void
meta_settings_unregister_proxy (MetaSettings      *settings,
                                MetaSettingsProxy *proxy)
{
  g_hash_table_remove (settings->proxies, proxy);
}
#endif
