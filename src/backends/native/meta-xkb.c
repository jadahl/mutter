...
/*
 * meta_xkb_create_key_event_from_evdev: Create a new Clutter ClutterKeyEvent
 * @device: a ClutterInputDevice
 * @stage: the stage the event should be delivered to
 * @xkb: XKB rules to translate the event
 * @time_ms: timestamp of the event
 ...
 */
ClutterEvent *
meta_xkb_create_key_event_from_evdev (ClutterInputDevice *device,
...
void
meta_xkb_set_event_state (ClutterEvent     *event,
