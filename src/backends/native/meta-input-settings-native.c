                                                ...
                                                guint              interval)
{
  ...
  meta_input_native_set_keyboard_repeat (META_INPUT_NATIVE (input),
                                                ...
                                                const gint              curve[4])
{
  ...
  meta_input_device_tool_native_set_pressure_curve (tool_native,
                                                    pressure_curve);
}
                                                  ...
                                                  GDesktopStylusButtonAction  secondary)
{
  ...
  meta_input_device_tool_native_set_button_code (tool_native,
