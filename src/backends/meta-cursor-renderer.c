...
{
  META_CURSOR_RENDERER_GET_CLASS (renderer)->realize_cursor_from_wl_buffer (
    renderer, cursor_sprite, buffer);
}
#endif
...
{
  META_CURSOR_RENDERER_GET_CLASS (renderer)->realize_cursor_from_xcursor (
    renderer, cursor_sprite, xc_image);
}
