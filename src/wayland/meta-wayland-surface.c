...
static void
unset_params_values (GArray *params_array)
{
  size_t i;
  GParameter *params = (GParameter *) params_array->data;

  for (i = 0; i < params_array->len; i++)
    {
                                     ...
                                     MetaWindow         *window)
{
  ...
  meta_wayland_surface_roll_shell_surface_managed (shell_surface_role, window);
}
