 ...
 */
static void
clutter_stage_do_paint (ClutterStage                *stage,
                        ...
                        const cairo_rectangle_int_t *clip)
{
  ...
  if (clip)
  ...
  else
    {
      ...
      clip_poly[0] = 0;
      clip_poly[1] = 0;
      clip_poly[2] = view_layout.width * window_scale;
      clip_poly[3] = 0;
      clip_poly[4] = view_layout.width * window_scale;
      clip_poly[5] = view_layout.height * window_scale;
      clip_poly[6] = 0;
      clip_poly[7] = view_layout.height * window_scale;
    }
                         ...
                         const cairo_rectangle_int_t *clip)
{
  ...
  clutter_stage_do_paint (stage, view, clip);
                                ...
                                ClutterStageView *view)
{
  ...
  */
  ...
  _clutter_stage_do_paint (stage, view, NULL);
                           ...
                           gint          height)
{
  ...
  clutter_stage_do_paint (stage, view, &clip_rect);
  ...
  if (paint)
    {
      _clutter_stage_maybe_setup_viewport (stage, view);
      cogl_push_framebuffer (framebuffer);
      clutter_stage_do_paint (stage, view, rect);
    }
