...
typedef struct _ClutterStageViewPrivate
{
  ...
  gboolean dirty_viewport   : 1;
  gboolean dirty_projection : 1;
                                 ...
                                 GParamSpec *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_FRAMEBUFFER:
      g_value_set_pointer (value, priv->framebuffer);
      break;
    }
}
                                 ...
                                 GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_LAYOUT:
      layout = g_value_get_pointer (value);
      priv->layout = *layout;
      break;
    case PROP_FRAMEBUFFER:
      priv->framebuffer = g_value_get_pointer (value);
      break;
    }
}
...
clutter_stage_view_class_init (ClutterStageViewClass *klass)
{
  ...
  obj_props[PROP_FRAMEBUFFER] =
    g_param_spec_pointer ("framebuffer",
                          "View framebuffer",
