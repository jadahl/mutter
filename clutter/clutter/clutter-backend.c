...
static ClutterBackend * (* custom_backend_creator) (void);
...
void
clutter_set_custom_backend (ClutterBackend *(* backend_creator) (void))
{
  custom_backend_creator = backend_creator;
}
...
_clutter_create_backend (void)
{
  ...
  if (custom_backend_creator)
    {
      retval = custom_backend_creator ();
